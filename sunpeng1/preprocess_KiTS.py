...
class LITS_preprocess:
    def __init__(self, raw_dataset_path,fixed_dataset_path, ):
        ...
        self.upper = 200
        self.lower = -200
        self.expand_slice = 5  # 轴向外侧扩张的slice数量
...
if __name__ == '__main__':
    for i in range(300):
        ...
        if i<10:
            raw_dataset_path = './kits19/data/'+'case_0000'+str(i)
            print(raw_dataset_path)
            fixed_dataset_path = './kits19/data2/'+'case_0000'+str(i)
            ...
            raw_dataset_path = './kits19/data/' + 'case_000'+str(i)
            print(raw_dataset_path)
            fixed_dataset_path = './kits19/data2/' + 'case_000' + str(i)

            tool = LITS_preprocess(raw_dataset_path, fixed_dataset_path)
            tool.fix_data()  # 对原始图像进行修剪并保存
            tool.write_train_val_name_list()  # 创建索引txt文件
        else:
            raw_dataset_path = './kits19/data/' + 'case_00' + str(i)
            print(raw_dataset_path)
            fixed_dataset_path = './kits19/data2/' + 'case_00'+str(i)
